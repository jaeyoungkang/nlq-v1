    ...
    <div className="font-sans text-slate-800 overflow-x-hidden bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 bg-white/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
                ...
                <Link href="/" className="bg-primary-500 text-white px-4 py-2 rounded-lg hover:bg-primary-600 transition font-semibold">
                    프로토타입 체험
                </Link>
            </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <Link href="/" className="bg-primary-500 text-white px-8 py-4 rounded-xl font-semibold hover:bg-primary-600 transition transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                            🚀 프로토타입 체험하기
                        </Link>
          ...
          <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden mb-8">
                  ...
                  <div className="p-6 bg-white border-t border-slate-200 flex flex-col sm:flex-row gap-4">
                      ...
                      <Link href="/" className="bg-primary-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-600 transition text-center">
                          실제 체험하기
                      </Link>
                  </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-gray-800 text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <Link href="/" className="inline-block bg-primary-600 text-white px-12 py-4 rounded-xl text-lg font-semibold hover:bg-primary-700 transition transform hover:-translate-y-1 shadow-2xl">
                  💫 무료로 체험하기
              </Link>
          </div>
      </section>
